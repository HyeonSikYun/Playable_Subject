...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    Bridge.define("Bottle", {
        ...
        props: {
            BottleColor: {
                get: function () {
if ( TRACE ) { TRACE( "Bottle#BottleColor#get", this ); }
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Bottle#init", this ); }
        ...
        methods: {
            /*Bottle.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "Bottle#Start", this ); }
...
if ( TRACE ) { TRACE( "Bottle#OnMouseDown", this ); }
...
if ( TRACE ) { TRACE( "Bottle#OnMouseDrag", this ); }
            ...
            OnMouseUp: function () {
if ( TRACE ) { TRACE( "Bottle#OnMouseUp", this ); }
...
if ( TRACE ) { TRACE( "Bottle#GetMouseWorldPos", this ); }
...
if ( TRACE ) { TRACE( "Bottle#FindClosestValidCase", this ); }
...
if ( TRACE ) { TRACE( "ButtonPulse#OnDisable", this ); }
    ...
    Bridge.define("Case", {
        ...
        props: {
            CaseColor: {
                get: function () {
if ( TRACE ) { TRACE( "Case#CaseColor#get", this ); }
...
if ( TRACE ) { TRACE( "Case#init", this ); }
        ...
        methods: {
            /*Case.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "Case#Start", this ); }
            ...
            /*Case.IsEmpty start.*/
            IsEmpty: function () {
if ( TRACE ) { TRACE( "Case#IsEmpty", this ); }
...
if ( TRACE ) { TRACE( "Case#SetCurrentBottle", this ); }
...
if ( TRACE ) { TRACE( "Case#ClearBottle", this ); }
...
if ( TRACE ) { TRACE( "Case#GetCurrentBottle", this ); }
...
if ( TRACE ) { TRACE( "Case#GetSnapPosition", this ); }
...
if ( TRACE ) { TRACE( "ItemCell#Highlight", this ); }
    ...
    Bridge.define("PuzzleManager", {
        ...
        methods: {
            ...
            Awake: function () {
if ( TRACE ) { TRACE( "PuzzleManager#Awake", this ); }
...
if ( TRACE ) { TRACE( "PuzzleManager#TestInitialLines", this ); }
...
if ( TRACE ) { TRACE( "PuzzleManager#CheckAndClearLine", this ); }
...
if ( TRACE ) { TRACE( "PuzzleManager#IsLineMatching", this ); }
...
if ( TRACE ) { TRACE( "PuzzleManager#ClearLine", this ); }
...
if ( TRACE ) { TRACE( "PuzzleManager#IsColorMatch", this ); }
...
if ( TRACE ) { TRACE( "PuzzleManager#DropLinesAbove", this ); }
            ...
            ShowGoodEffect: function (worldPosition) {
if ( TRACE ) { TRACE( "PuzzleManager#ShowGoodEffect", this ); }
...
if ( TRACE ) { TRACE( "TimerSlider#Update", this ); }
    ...
    Bridge.define("UIScaler", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "UIScaler#init", this ); }
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "UIScaler#Start", this ); }
            ...
            Update: function () {
if ( TRACE ) { TRACE( "UIScaler#Update", this ); }
...
if ( TRACE ) { TRACE( "UIScaler#UpdateUIScale", this ); }
...
if ( TRACE ) { TRACE( "UnityEngine.UI.Extensions.CasualGame.UIParticleSystem#PauseParticleEmission", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["UnityEngine","System","System.Collections","System.Collections.Generic","TMPro","UnityEngine.UI","DG.Tweening","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
