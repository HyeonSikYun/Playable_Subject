...
if ( TRACE ) { TRACE( "GameManager#CheckInitialBoard", this ); }
...
if ( TRACE ) { TRACE( "GameManager#ShowGoodEffect", this ); }
...
if ( TRACE ) { TRACE( "ItemCell#Highlight", this ); }
    ...
    Bridge.define("TextHint", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "TextHint#init", this ); }
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "TextHint#Start", this ); }
...
if ( TRACE ) { TRACE( "TextHint#AnimateLoop", this ); }
    ...
    Bridge.define("TimerSlider", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "TimerSlider#init", this ); }
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "TimerSlider#Start", this ); }
            ...
            Update: function () {
if ( TRACE ) { TRACE( "TimerSlider#Update", this ); }
